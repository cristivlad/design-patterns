...
public class TemplateMethodTest {
    ...
    public void testTaxPayerClassStructure() throws Exception {
        ...
        assertTrue(isFinal(calculateTax), "usually the template method is final");
        assertTrue(isPublic(calculateTax), "usually the template method is public");
        ...
        for (Method method : methods) {
            if (!method.getName().equals("calculateTax")) {
                ...
                assertTrue(isProtected(method),"usually the primitive operations are protected");
                assertTrue(isAbstract(method), "usually the primitive operations are abstract");
            }
        }
    }
